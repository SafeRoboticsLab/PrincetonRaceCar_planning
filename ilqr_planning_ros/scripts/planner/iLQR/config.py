...
class Config():
    def __init__(self):
        ...
        self.reg_init = 1
        self.reg_scale_up = 10 # scale up factor for regularization
        ...
        self.path_weight = 2 # weight for the path deviation cost
        ...
        self.vel_weight = 0 # weight for the velocity cost
        ...
        self.lat_accel_a = 10 # parameter for lateral acceleration cost
        self.lat_accel_b = 1. # parameter for ExpLinear Cost
